...
export const SearchForm: React.FC<Props> = ({ onSearch }) => {
  ...
  return (
    <div
      className="w-full max-w-7xl mx-auto py-10 mb-20 px-4 sm:px-6 lg:px-8 mt-10 bg-[#36373a] rounded-[8px] "
      style={{
        boxShadow:
    ...
    >
      <div className="flex flex-col space-y-3">
        ...
        <div
          ref={dropdownRef}
          className="flex items-center space-x-4 relative z-30"
        >
          {/* Trip Type Dropdown */}
          <div className="relative">
            <button
              type="button"
              className="flex items-center space-x-2 text-[#e8eaed] hover:bg-[#303134] rounded-full px-3 py-1.5 transition-colors"
        ...
        {/* Main search form with lower z-index */}
        <form onSubmit={handleSubmit} className="relative">
          <div className="overflow-visible relative z-10">
            <div className="flex flex-col md:flex-row p-1">
              ...
              <div className="flex-1 border-t md:border-t-0 md:border-l border-[#5f6368]">
                <DateSelector
          ...
          {/* Search button with higher z-index */}
          <div className="absolute left-1/2 transform -translate-x-1/2 translate-y-[10px] z-10">
            <button
              type="submit"
              disabled={isSearching}
              className="bg-[#8ab4f8] hover:bg-[#aecbfa] text-[#202124] font-medium px-8 py-3 rounded-full transition-colors shadow-[0_1px_3px_rgba(0,0,0,0.3)]"
            >
